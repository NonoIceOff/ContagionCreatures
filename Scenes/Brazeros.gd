	...
	if entered == true and Key == false and clicked == false:
		if Input.is_action_just_pressed("ui_interact"):
			...
			if Global.brazero_numbers == 5:
				get_node("../Control/TileMap").set_cell(0, Vector2(0,3), 0, Vector2(28,6), 0)
				get_node("../Control/TileMap").set_cell(1, Vector2(0,3)+Vector2(0,-1), 0, Vector2(18,5), 0)
			if Global.brazero_numbers == 10:
				get_node("../Control/TileMap").set_cell(0, Vector2(0,11), 0, Vector2(28,6), 0)
				get_node("../Control/TileMap").set_cell(1, Vector2(0,11)+Vector2(0,-1), 0, Vector2(18,5), 0)
			if Global.brazero_numbers == 15:
				get_node("../Control/TileMap").set_cell(0, Vector2(0,19), 0, Vector2(28,6), 0)
				get_node("../Control/TileMap").set_cell(1, Vector2(0,19)+Vector2(0,-1), 0, Vector2(18,5), 0)
			if Global.brazero_numbers == 20:
				get_node("../Control/TileMap").set_cell(0, Vector2(0,27), 0, Vector2(28,6), 0)
				get_node("../Control/TileMap").set_cell(1, Vector2(0,27)+Vector2(0,-1), 0, Vector2(18,5), 0)
